...
from wsl_survey.irn.net.resnet50_cam import Net

cudnn.enabled = True
from torch.utils.data import DataLoader
import torch.nn.functional as F

from wsl_survey.irn import dataloader, pyutils, torchutils
...
def run(args, cam_weights_name=None):
    model = Net()
    ...
    torch.save(
        model.module.state_dict() if use_cuda else model.module.state_dict(),
        cam_weights_name)
    if use_cuda:
