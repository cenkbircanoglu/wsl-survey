...
from wsl_survey.wildcat.util import AveragePrecisionMeter
...
class Engine(object):
    ...
    def learning(self,
        ...
        for epoch in range(self.state['start_epoch'],
...
class MulticlassEngine(Engine):
    ...
    def on_end_epoch(self,
        ...
        if display:
            if training:
                ...
                print('Epoch: [{0}]\t'
                      'Loss {loss:.4f}\t'
                      'Prec@1 {top1:.3f}'.format(self.state['epoch'],
                                                 loss=loss,
                                                 top1=top1))
            else:
                print('Test: \t Loss {loss:.4f}\t Prec@1 {top1:.3f}'.format(
                    loss=loss, top1=top1))
    ...
    def on_end_batch(self,
        ...
        # measure accuracy
        self.state['classacc'].add(self.state['output'].data,
                                   self.state['target'])
...
class MulticlassTop5Engine(Engine):
    def __init__(self, state):
        Engine.__init__(self, state)
        self.state['classacc'] = tnt.meter.ClassErrorMeter(topk=[1, 5],
                                                           accuracy=True)
        ...
        if display:
            if training:
                print('Epoch: [{0}]\t'
                      'Loss {loss:.4f}\t'
                      'Prec@1 {top1:.3f}\t'
                      'Prec@5 {top5:.3f}'.format(self.state['epoch'],
                                                 loss=loss,
                                                 top1=top1,
                                                 top5=top5))
            else:
                print('Test: \t'
                      'Loss {loss:.4f}\t'
                      'Prec@1 {top1:.3f}\t'
                      'Prec@5 {top5:.3f}'.format(loss=loss,
                                                 top1=top1,
                                                 top5=top5))
    ...
    def on_end_epoch(self,
        ...
        if display:
            if training:
                ...
                print('Epoch: [{0}]\t'
                      'Loss {loss:.4f}\t'
                      'mAP {map:.3f}'.format(self.state['epoch'],
                                             loss=loss,
                                             map=map))
            else:
