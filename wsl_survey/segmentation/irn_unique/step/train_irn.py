...
from wsl_survey.segmentation.irn_unique.misc import pyutils, torchutils, indexing
...
if __name__ == '__main__':
    from wsl_survey.segmentation.irn_unique.config import make_parser
    import os
    ...
    parser.set_defaults(
        ...
        infer_list='./data/test1/VOC2012/ImageSets/Segmentation/train.txt',
        irn_weights_name='./outputs/test1/results/resnet18/sess/irn_unique.pth',
        irn_network='ResNet18',
        irn_network_module='wsl_survey.segmentation.irn_unique.net.resnet_irn',
        irn_num_epoches=1,
        irn_batch_size=4)
