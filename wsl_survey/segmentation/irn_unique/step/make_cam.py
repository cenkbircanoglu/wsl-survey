...
from wsl_survey.segmentation.irn_unique.misc import torchutils, imutils
...
def run(args):
    ...
    model = getattr(importlib.import_module(args.cam_network_module),
                    args.cam_network + 'CAM')(num_classes=10582)
    if use_gpu:
...
if __name__ == '__main__':
    ...
    parser.set_defaults(
        ...
        cam_network_module='wsl_survey.segmentation.irn_unique.net.resnet_cam',
    )
