...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_aug_list",
                        default='/Users/cenk.bircanoglu/wsl/wsl_survey/data/voc12/train_aug.txt',
                        type=str)
    ...
    parser.add_argument("--out",
                        default="/Users/cenk.bircanoglu/wsl/wsl_survey/data/voc12/cls_labels_test.npy",
                        type=str)
    parser.add_argument("--voc12_root",
                        default="/Users/cenk.bircanoglu/wsl/wsl_survey/datasets/voc2012/tmp/VOCdevkit/VOC2012",
                        type=str)
    ...
    label_list = dataloader.load_image_label_list_from_xml(train_val_name_list,
                                                           args.voc12_root)
