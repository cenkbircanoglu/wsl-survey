...
if __name__ == '__main__':
    nets = [resnet_cam.ResNet18, resnet_cam.ResNet34, resnet_cam.ResNet50,
            resnet_cam.ResNet101, resnet_cam.ResNet152]
    find_smallest(nets)

    nets = [resnet_cam.ResNet18CAM, resnet_cam.ResNet34CAM,
            resnet_cam.ResNet50CAM,
            resnet_cam.ResNet101CAM, resnet_cam.ResNet152CAM]
    find_smallest(nets)

    nets = [resnet_irn.ResNet18, resnet_irn.ResNet34, resnet_irn.ResNet50,
    ...
    nets = [partial(resnet_irn.ResNet18AffinityDisplacementLoss,
    ...
    nets = [resnet_irn.ResNet18EdgeDisplacement,
