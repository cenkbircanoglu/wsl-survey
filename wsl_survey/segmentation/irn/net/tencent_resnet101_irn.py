...
from wsl_survey.segmentation.irn.net import tencent_resnet101
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # backbone
        self.resnet101 = tencent_resnet101.tencent_resnet101(pretrained=True,
                                                             strides=[2, 2, 2,
                                                                      1])
        ...
        self.stage2 = nn.Sequential(self.resnet101.layer1)
        self.stage3 = nn.Sequential(self.resnet101.layer2)
        self.stage4 = nn.Sequential(self.resnet101.layer3)
        self.stage5 = nn.Sequential(self.resnet101.layer4)
