...
from wsl_survey.segmentation.irn.net import resnet50
...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        self.backbone_model = resnet50.resnet50(pretrained=True,
                                                strides=(2, 2, 2, 1))

        self.stage1 = nn.Sequential(self.backbone_model.conv1, self.backbone_model.bn1,
                                    self.backbone_model.relu, self.backbone_model.maxpool,
