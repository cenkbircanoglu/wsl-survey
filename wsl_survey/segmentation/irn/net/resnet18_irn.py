...
class Net(nn.Module):
    ...
    def __init__(self):
        ...
        # backbone
        self.resnet34 = resnet.resnet18(pretrained=True)

        self.stage1 = nn.Sequential(self.resnet34.conv1, self.resnet34.bn1,
                                    self.resnet34.relu, self.resnet34.maxpool)
        self.stage2 = nn.Sequential(self.resnet34.layer1)
        self.stage3 = nn.Sequential(self.resnet34.layer2)
        self.stage4 = nn.Sequential(self.resnet34.layer3)
        self.stage5 = nn.Sequential(self.resnet34.layer4)
