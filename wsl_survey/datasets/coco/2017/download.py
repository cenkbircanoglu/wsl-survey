...
def download(output):
    ...
    trainval_stuff_anno_filename, trainval_stuff_anno_cached_file = download_if_not_exists(
        'trainval_stuff_anno', tmp_dir, urls)
    unzip_file(trainval_stuff_anno_cached_file, output)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='COCO 2017 Dataset Downloader')
